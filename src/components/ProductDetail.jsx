...
const ProductDetail = () => {
  ...
  return (
    <div>
      ...
      <div className="ps-6 flex flex-col md:flex-row gap-6 max-w-6xl mx-auto items-center justify-center">
        ...
        <div className="flex-1 flex flex-col md:flex-row items-center">
          ...
          <div className="mt-6 text-center px-5">
            <p className="md:text-3xl sm:text-sm font-bold text-gray-900">{product.name}</p>
            ...
            relatedProducts.map((item) => (
              ...
              >
                <img
                  ...
                  alt={item.name}
                  className="w-full md:h-40 sm:h-10 object-cover rounded-lg"
                />
                <p className="md:text-lg sm:text-sm font-bold text-gray-900 mt-2">{item.name}</p>
