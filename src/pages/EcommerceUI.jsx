...
<section id="products-section" className="w-full px-6 md:px-16 py-12">
  ...
  <div className="flex flex-col md:flex-row gap-8">
    ...
    <aside className="w-full md:w-64 flex-shrink-0">
      ...
      {/* DESKTOP VIEW: Sidebar (Vertical List) */}
      {/*<div className="hidden md:flex flex-col gap-2 sticky top-32">
        <h3 className="text-sm font-uppercase tracking-widest text-gray-400 mb-2 px-2">CATEGORIES</h3>
        <button
          onClick={() => setSelectedCategory("All")}
          className={`text-left px-4 py-2 rounded-md transition-all duration-200 ${
            selectedCategory === "All"
              ? "bg-black text-white shadow-md translate-x-2"
